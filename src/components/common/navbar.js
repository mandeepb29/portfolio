...
<div className="container">
 <nav className={`flex flex-row justify-between items-center transition-all ease-in duration-200 z-50 delay-300 py-4 border-b border-b-gray ${isScrolled?'border-opacity-25':'border-opacity-0'}`}>
  ...
  <div className="cursor-pointer py-1 px-3 w-16 h-12 z-50 flex flex-col xl:hidden content-center items-center" id='hamburgerBtn'>
    <div className='inline-block h-1 mb-2 w-full rounded-md bg-gradient-to-r from-purplelight to-purplelight2'></div>
    <div className='inline-block h-1 mb-1 w-full rounded-md bg-gradient-to-r from-purplelight to-purplelight2'></div>
    <span className='text-xs text-lightgray font-syne font-bold'>menu</span>
  </div>

      <div className='transition-all ease-out-cubic duration-300 h-screen fixed top-0 left-0 w-full opacity-0 invisible xl:visible xl:relative xl:opacity-100 xl:h-auto flex flex-col xl:flex-row xl:justify-end justify-between pb-8 bg-dark pt-32 xl:pt-3 xl:pb-3 px-8 xl:px-6 z-40' id='navMenu'>
