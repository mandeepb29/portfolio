...
export default function ProjectTemplate({
  ...
  const lighterHsl = { ...hsl, l: Math.min(hsl.l + 0.25, 1) };
...
const gradientStyle = {
  background: `linear-gradient(170.33deg, ${lighterShade} ,${nearWhiteShade},${lighterShade})`,
};

console.log("shades generated - ",lighterShade, gradientStyle);
